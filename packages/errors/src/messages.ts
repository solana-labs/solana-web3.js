import {
    ...
    SOLANA_ERROR__TRANSACTION__SIGNATURES_LENGTH_NUM_SIGNERS_MISMATCH,
...
export const SolanaErrorMessages: Readonly<{
    ...
    [SOLANA_ERROR__TRANSACTION__SIGNATURES_LENGTH_NUM_SIGNERS_MISMATCH]:
        'Attempted to decode a transaction that has `$signaturesLength` signatures but expects `$signerAddressesLength` signers.',
