...
export const SOLANA_ERROR__SUBTLE_CRYPTO_DISALLOWED_IN_INSECURE_CONTEXT = 3610000 as const;
export const SOLANA_ERROR__SUBTLE_CRYPTO_DIGEST_UNIMPLEMENTED = 3610001 as const;
export const SOLANA_ERROR__SUBTLE_CRYPTO_ED25519_ALGORITHM_UNIMPLEMENTED = 3610002 as const;
export const SOLANA_ERROR__SUBTLE_CRYPTO_EXPORT_FUNCTION_UNIMPLEMENTED = 3610003 as const;
export const SOLANA_ERROR__SUBTLE_CRYPTO_GENERATE_FUNCTION_UNIMPLEMENTED = 3610004 as const;
export const SOLANA_ERROR__SUBTLE_CRYPTO_SIGN_FUNCTION_UNIMPLEMENTED = 3610005 as const;
export const SOLANA_ERROR__SUBTLE_CRYPTO_VERIFY_FUNCTION_UNIMPLEMENTED = 3610006 as const;
...
export const SOLANA_ERROR__TRANSACTION_SIGNATURES_MISSING = 5663010 as const;
export const SOLANA_ERROR__TRANSACTION_ADDRESS_MISSING = 5663011 as const;
export const SOLANA_ERROR__TRANSACTION_FEE_PAYER_MISSING = 5663012 as const;
export const SOLANA_ERROR__TRANSACTION_FEE_PAYER_SIGNATURE_MISSING = 5663013 as const;
export const SOLANA_ERROR__TRANSACTION_INVALID_NONCE_TRANSACTION_INSTRUCTIONS_MISSING = 5663014 as const;
export const SOLANA_ERROR__TRANSACTION_INVALID_NONCE_TRANSACTION_FIRST_INSTRUCTION_MUST_BE_ADVANCE_NONCE =
    5663015 as const;
...
export const SOLANA_ERROR__CODECS_INVALID_BYTE_LENGTH = 8078001 as const;
export const SOLANA_ERROR__CODECS_EXPECTED_FIXED_LENGTH = 8078002 as const;
export const SOLANA_ERROR__CODECS_EXPECTED_VARIABLE_LENGTH = 8078003 as const;
export const SOLANA_ERROR__CODECS_ENCODER_DECODER_SIZE_COMPATIBILITY_MISMATCH = 8078004 as const;
export const SOLANA_ERROR__CODECS_ENCODER_DECODER_FIXED_SIZE_MISMATCH = 8078005 as const;
export const SOLANA_ERROR__CODECS_ENCODER_DECODER_MAX_SIZE_MISMATCH = 8078006 as const;
export const SOLANA_ERROR__CODECS_INVALID_NUMBER_OF_ITEMS = 8078007 as const;
...
export const SOLANA_ERROR__RPC_TRANSPORT_HTTP_HEADER_FORBIDDEN = 8100001 as const;
...
export type SolanaErrorCode =
    | typeof SOLANA_ERROR__TRANSACTION_SIGNATURES_MISSING
    | typeof SOLANA_ERROR__TRANSACTION_FEE_PAYER_SIGNATURE_MISSING
    ...
    | typeof SOLANA_ERROR__RPC_TRANSPORT_HTTP_HEADER_FORBIDDEN
    | typeof SOLANA_ERROR__RPC_TRANSPORT_HTTP_ERROR
    | typeof SOLANA_ERROR__SUBTLE_CRYPTO_DISALLOWED_IN_INSECURE_CONTEXT
    | typeof SOLANA_ERROR__SUBTLE_CRYPTO_DIGEST_UNIMPLEMENTED
    | typeof SOLANA_ERROR__SUBTLE_CRYPTO_ED25519_ALGORITHM_UNIMPLEMENTED
    | typeof SOLANA_ERROR__SUBTLE_CRYPTO_EXPORT_FUNCTION_UNIMPLEMENTED
    | typeof SOLANA_ERROR__SUBTLE_CRYPTO_GENERATE_FUNCTION_UNIMPLEMENTED
    | typeof SOLANA_ERROR__SUBTLE_CRYPTO_SIGN_FUNCTION_UNIMPLEMENTED
    | typeof SOLANA_ERROR__SUBTLE_CRYPTO_VERIFY_FUNCTION_UNIMPLEMENTED
    | typeof SOLANA_ERROR__CODECS_CANNOT_DECODE_EMPTY_BYTE_ARRAY
    | typeof SOLANA_ERROR__CODECS_INVALID_BYTE_LENGTH
    | typeof SOLANA_ERROR__CODECS_EXPECTED_FIXED_LENGTH
    | typeof SOLANA_ERROR__CODECS_EXPECTED_VARIABLE_LENGTH
    | typeof SOLANA_ERROR__CODECS_ENCODER_DECODER_SIZE_COMPATIBILITY_MISMATCH
    | typeof SOLANA_ERROR__CODECS_ENCODER_DECODER_FIXED_SIZE_MISMATCH
    | typeof SOLANA_ERROR__CODECS_ENCODER_DECODER_MAX_SIZE_MISMATCH
    | typeof SOLANA_ERROR__CODECS_INVALID_NUMBER_OF_ITEMS
    ...
    | typeof SOLANA_ERROR__TRANSACTION_INVALID_NONCE_TRANSACTION_FIRST_INSTRUCTION_MUST_BE_ADVANCE_NONCE
    | typeof SOLANA_ERROR__TRANSACTION_INVALID_NONCE_TRANSACTION_INSTRUCTIONS_MISSING
    ...
    | typeof SOLANA_ERROR__TRANSACTION_ADDRESS_MISSING
    | typeof SOLANA_ERROR__TRANSACTION_FEE_PAYER_MISSING
