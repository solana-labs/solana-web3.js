...
import { SOLANA_SCHEMA, Struct } from './borsh-schema';

let shouldSetGlobalSchema = true;
function setGlobalSchema() {
    shouldSetGlobalSchema = false;
...
export class PublicKey extends Struct {
    ...
    static decode(data: Buffer): any {
        shouldSetGlobalSchema && setGlobalSchema();
    ...
    static decodeUnchecked(data: Buffer): any {
        shouldSetGlobalSchema && setGlobalSchema();
        return super.decodeUnchecked(data);
    }
     ...
     */
    /* eslint-disable require-await */
    static async createProgramAddress(seeds: Array<Buffer | Uint8Array>, programId: PublicKey): Promise<PublicKey> {
