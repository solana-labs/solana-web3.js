...
export const mockTransactionSystem = {
    ...
    result: {
        ...
        meta: {
            ...
            preBalances: [
                742462160, 0, 5616720, 2039280, 0, 2039280, 18144720, 0, 0, 10203360, 0, 1, 4108677884, 1224960,
                2345520, 2853600, 731913600, 1141440, 1134480, 1141440, 1461600, 1141440, 1169280, 1009200, 143487360,
                934087680,
            ],
            preTokenBalances: [
                {
...
export const mockTransactionStake = {
    ...
    result: {
        ...
        meta: {
            ...
            postBalances: [
                969985000, 30000000, 6258473240, 100000000, 42706560, 1009200, 51241152368, 1169280, 114979200, 960480,
                1, 521498880, 1,
            ],
            postTokenBalances: [],
            preBalances: [
