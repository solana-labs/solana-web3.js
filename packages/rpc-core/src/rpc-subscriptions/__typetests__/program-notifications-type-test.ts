...
import type { Base58EncodedBytes, Base58EncodedDataResponse, Base64EncodedBytes, Base64EncodedDataResponse, Base64EncodedZStdCompressedDataResponse, LamportsUnsafeBeyond2Pow53Minus1 } from '@solana/rpc-types';
