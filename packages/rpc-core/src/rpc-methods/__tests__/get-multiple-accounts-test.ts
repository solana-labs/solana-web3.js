    ...
    (['confirmed', 'finalized', 'processed'] as Commitment[]).forEach(commitment => {
        describe(`when called with \`${commitment}\` commitment`, () => {
            it('returns account info for multiple accounts', async () => {
                ...
                expect(multipleAccounts.value[1]).toMatchObject({
                    data: ['', 'base64'],
                    executable: false,
                    lamports: 5000000n,
                    owner: '11111111111111111111111111111111',
                                ...
                                extensions: [
                                    {
                                        ...
                                        state: {
                                            ...
                                            transferFeeConfigAuthority: '7MyTjmRygJoCuDBUtAuSugiYZFULD2SWaoUTmtjtRDzD',
                                            withdrawWithheldAuthority: '7MyTjmRygJoCuDBUtAuSugiYZFULD2SWaoUTmtjtRDzD',
                                            withheldAmount: 0n,
                                        },
                                    },
                                ],
